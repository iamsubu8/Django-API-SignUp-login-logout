...
def home(self):
    return Response({"status":1,"message":"Home Page of Thbred Project"})
...
class UserRegistrationView(APIView):
    ...
    def post(self, request):
        try:
            ...
            logger.exception("user could not register")
            return Response({'status': 0,'message': 'user could not register'},status = status.HTTP_200_OK)
